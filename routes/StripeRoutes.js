...
router.post('/create-checkout-session', protect, async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: `https://workwithtrust-frontend.vercel.app/success?gigId=${gigId}&session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `https://workwithtrust-frontend.vercel.app//cancel`,
      metadata: {
